...
def build_iterator(file_path, text_field=None, batch_size=1, shuffle=True, spcay_load='en_core_web_sm', vector_file_name='glove.6B.50d.txt', train_tag='train', device=-1):
